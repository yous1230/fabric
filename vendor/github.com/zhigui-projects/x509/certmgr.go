...
func (c *CertificateMgr) CreateCertificateRequestToMem(template *x.CertificateRequest, privKey *sm2.PrivateKey) ([]byte, error) {
...
func (c *CertificateMgr) CreateCertificateToMem(template, parent *x.Certificate, pubKey *sm2.PublicKey, privKey *sm2.PrivateKey) ([]byte, error) {
...
func (c *CertificateMgr) CreateCertificateToPem(FileName string, template, parent *x.Certificate, pubKey *sm2.PublicKey, privKey *sm2.PrivateKey) (bool, error) {
	der, err := c.CreateCertificate(rand.Reader, template, parent, pubKey, privKey)
	if err != nil {
		return false, err
	}
